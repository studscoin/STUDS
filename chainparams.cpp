...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04060cddf8a7eb70085ddab5ff90ea821de0375c56e881c54cd8c1144ec030ca48ddb150f9d0c5f02937ae6dcf201a05efed40746ca3e2dd6330a8b07c9e4888a1") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (880088, uint256("0xef60389c005bc4ced313d23d35b4df021cdfa9fdf11ff331557573a28ee468ab")); //NEW Wallet Version
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1692601785, // * UNIX timestamp of last checkpoint block
    1799036,		// * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1622407658, 14109257, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000080047121d8857fd183fddf47a9cd0c5b4d5f0a5e1d04704f03e91e95c1"));
        assert(genesis.hashMerkleRoot == uint256S("0xad4b627711cc14c63cd1264bba794186735173ecabf6a84612e4f0ba95e17e720"));
        ...
        // spork keys
        consensus.strSporkPubKey = "045fb8afbad285b73641e7164fa988bcff1b509abc9a65a6a7d82546f9cb93acaff8f4182450f58efc773bcf80674c69592e3b9c5086cd4bfb6bfda5db7d2c8002";
        ...
        consensus.mBurnAddresses = {
           { "StudsCoinBuRnSTUDSxxxxxxxxxwNqgnW", 0 }
        };
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                  = 880056;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight              = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].nActivationHeight      = 880056;
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight       = 880056;
        consensus.vUpgrades[Consensus::UPGRADE_P2PKH_BLOCK_SIGNATURES].nActivationHeight = 880056;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V2].nActivationHeight     = 880056;
        consensus.vUpgrades[Consensus::UPGRADE_MASTERNODE_RANK_V2].nActivationHeight     = 880056;
        ...
        vSeeds.push_back(CDNSSeedData("1", "seed1.studentscoin.net"));
        vSeeds.push_back(CDNSSeedData("2", "seed2.studentscoin.net"));
	    vSeeds.push_back(CDNSSeedData("3", "seed3.studentscoin.net"));
	    vSeeds.push_back(CDNSSeedData("4", "seed4.studentscoin.net"));
	    vSeeds.push_back(CDNSSeedData("5", "seed5.studentscoin.net"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // studs starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.studscoin.net", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet studs addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet studs script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet studs BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet studs BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet studs BIP44 coin type is '1' (All coin's testnet default)
