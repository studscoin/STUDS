...
#   c) node1 mines 32 blocks, so now node 0 has 60001STUDS, node 1 has 4250STUDS, node2 has none.
#   d) node0 sends 601 STUDS to node2, in two transactions (301 STUDS, then 300 STUDS).
