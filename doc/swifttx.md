...
This mechanism has been integrated into Bitcore-Node-Studscoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Studscoin-Project/insight-api-studscoin#web-socket-api](https://github.com/Studscoin-Project/insight-api-studscoin#web-socket-api) 
* API: [https://github.com/Studscoin-Project/insight-api-studscoin#swifttx-transactions](https://github.com/Studscoin-Project/insight-api-studscoin#swifttx-transactions) 
...
By default, the Studscoin daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Studscoin daemon:
