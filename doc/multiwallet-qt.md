...
In order to support loading of multiple wallets in studscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is studscoin.cpp.
...
Changes to studscoin.cpp
----------------------
studscoin.cpp is the entry point into studscoin-qt, and as such, will require some minor modifications to provide hooks for
