Contributing to Studscoin
============================

The Studscoin project operates an open contributor model where anyone is
...
The following applies to code changes to the Studscoin project, and is not to be
confused with overall Studscoin Network Protocol consensus changes.

Whether a pull request is merged into Studscoin rests with the project merge
...
Where a patch set proposes to change the Studscoin consensus, it must have been
...
The project leader is the release manager for each Studscoin release.
