Contributing to Studscoin Core
============================

The Studscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Studscoin Core project, and is not to be
confused with overall Studscoin Network Protocol consensus changes.

Whether a pull request is merged into Studscoin Core rests with the project merge
...
Patches that change Studscoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Studscoin consensus, it must have been
...
The project leader is the release manager for each Studscoin Core release.
