...
void AddressTableModel::updateEntry(const QString& address,
    ...
    int status)
{
    // Update address book model from Studscoin
...
{
    emit dataChanged(index(idx, 0, QModelIndex()), index(idx, colustuds.length() - 1, QModelIndex()));
}
