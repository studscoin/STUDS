...
/* Studscoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Studscoin"
#define QAPP_ORG_DOMAIN "studscoin.online"
#define QAPP_APP_NAME_DEFAULT "Studscoin-Qt"
#define QAPP_APP_NAME_TESTNET "Studscoin-Qt-testnet"
