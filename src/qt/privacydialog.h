...
public:
    ...
    void setZSTUDSControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzstuds_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzstuds_clicked();
    void on_pushButtonZSTUDSControl_clicked();
