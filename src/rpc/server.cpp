...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* STUDS features */
        {"studs", "listmasternodes", &listmasternodes, true },
        {"studs", "getmasternodecount", &getmasternodecount, true },
        {"studs", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"studs", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"studs", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"studs", "masternodecurrent", &masternodecurrent, true },
        {"studs", "startmasternode", &startmasternode, true },
        {"studs", "createmasternodekey", &createmasternodekey, true },
        {"studs", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"studs", "listmasternodeconf", &listmasternodeconf, true },
        {"studs", "getmasternodestatus", &getmasternodestatus, true },
        {"studs", "getmasternodewinners", &getmasternodewinners, true },
        {"studs", "getmasternodescores", &getmasternodescores, true },
        {"studs", "preparebudget", &preparebudget, true },
        {"studs", "submitbudget", &submitbudget, true },
        {"studs", "mnbudgetvote", &mnbudgetvote, true },
        {"studs", "getbudgetvotes", &getbudgetvotes, true },
        {"studs", "getnextsuperblock", &getnextsuperblock, true },
        {"studs", "getbudgetprojection", &getbudgetprojection, true },
        {"studs", "getbudgetinfo", &getbudgetinfo, true },
        {"studs", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"studs", "mnfinalbudget", &mnfinalbudget, true },
        {"studs", "checkbudgets", &checkbudgets, true },
        {"studs", "mnsync", &mnsync, true },
        {"studs", "spork", &spork, true },
...
{
    return "> studs-cli " + methodname + " " + args + "\n";
}
