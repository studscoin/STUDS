...
#ifndef Studscoin_ZSTUDSTRACKER_H
#define Studscoin_ZSTUDSTRACKER_H
...
public:
    CzstudsTracker(std::string strWalletFile);
    ~CzstudsTracker();
...
#endif //Studscoin_ZSTUDSTRACKER_H
