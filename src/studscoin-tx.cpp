...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Studscoin studscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  studscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded studscoin transaction") + "\n" +
                               "  studscoin-tx [options] -create [commands]   " + _("Create hex-encoded studscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded studscoin transaction
