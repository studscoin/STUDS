...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='studscoin.conf'
CONFIGFOLDER='/root/.studscoin'
COIN_DAEMON='studsd'
COIN_CLI='studs-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/TeamStudscoin/studscoin/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
