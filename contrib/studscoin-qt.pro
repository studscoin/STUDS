...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/studscoin-cli.cpp \
           src/studscoin-tx.cpp \
           src/studscoin.cpp \
           src/db.cpp \
           ...
           src/qt/studscoin.cpp \
           src/qt/studscoinstrings.cpp \
...
RESOURCES += src/qt/studscoin.qrc src/qt/studscoin_locale.qrc

TRANSLATIONS += src/qt/locale/studscoin_bg.ts \
                src/qt/locale/studscoin_de.ts \
                src/qt/locale/studscoin_en.ts \
                src/qt/locale/studscoin_es.ts \
                src/qt/locale/studscoin_fi.ts \
                src/qt/locale/studscoin_fr.ts \
                src/qt/locale/studscoin_it.ts \
                src/qt/locale/studscoin_ja.ts \
                src/qt/locale/studscoin_pl.ts \
                src/qt/locale/studscoin_pt.ts \
                src/qt/locale/studscoin_ru.ts \
                src/qt/locale/studscoin_sk.ts \
                src/qt/locale/studscoin_sv.ts \
                src/qt/locale/studscoin_vi.ts \
                src/qt/locale/studscoin_zh_CN.ts \
                src/qt/locale/studscoin_zh_TW.ts
