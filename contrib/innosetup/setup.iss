...
#define MyAppName "Studscoin Core"
#define MyAppPublisher "2021-2022 The Studscoin Developers"
#define MyAppURL "https://github.com/TeamStudscoin/studscoin"
#define MyAppExeName "studs-qt.exe"
#define MyAppExtraData "https://github.com/TeamStudscoin/studscoin/releases/download/v2.0/bootstrap.zip"
...
DefaultDirName={autopf}\Studscoin
...
OutputDir=.\output
OutputBaseFilename=StudscoinSetup
...
DefaultGroupName=Studscoin Core
...
[Files]
Source: ".\package\studs-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Studscoin\Studscoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Studscoin\Studscoin-Qt,strDataDir|{userappdata}\Studscoin\}');
  Result := True;
end;
