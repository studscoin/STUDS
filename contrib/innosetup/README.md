...
* Fill in the following data:
    * Application Name: `Studscoin Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The Studscoin Developers`
    * Application Website: `https://studscoin.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Studscoin`
* Add application files:
    * Select the file `studs-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `studs-2.0.0-win64-setup.exe`
