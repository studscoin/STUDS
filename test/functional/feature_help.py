...
"""Verify that starting studs with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start studs with -? for help text")
        ...
        self.log.info("Start studs with -version for version information")
